...
export default function ResumeCoverLetterConvertor() {
    ...
    return (
        ...
        >
            {/* Description */}
            <p className="text-sm">
                Job searching can be frustrating. You spend hours rewriting your resume and cover letter for each role. Our tool fixes that. It matches your resume and cover letter to the job description in minutes. No more guessing what to change or where to start. Save time, stay focused, and make your search less stressful. <strong className="text-red-500">NOTE: Our tool may take 3 &ndash; 5 minutes to process your input, please be patient and don&apos;t refresh the page.</strong>
            </p>
